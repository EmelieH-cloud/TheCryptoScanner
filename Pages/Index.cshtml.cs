       ...
       , "0x", "0x0-ai-ai-smart-contract", "0x1-tools-ai-multi-tool",
        ...
        public async Task<IActionResult> OnPost()
        {
            try
            {
                ...
                CoinInfoRoot firstresponse = await new ApiCaller().MakeCall<CoinInfoRoot>($"coins/{SearchTerm}");
                coinViewModel = new ViewModel
                {
                    Name = firstresponse.Name,
                    Symbol = firstresponse.Symbol,
                };
                ...
                {
                    if (term.ToLower() != SearchTerm.ToLower()) continue;
